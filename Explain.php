...
class Explain
{
     ...
     * @var array
     */
    private static $support = ["select_type", "type", "possible_keys", "key", "rows", "extra"];
     ...
     * @return bool
     */
    public static function ifConfarrNotice($explainKey, $explainResult, array $filterConf)
    {
     ...
     * @return bool
     */
    public static function ifRetarrNotice($explainKey, $userCond, array $explainResultArr)
    {
        $explainKey = self::str_trim_lower($explainKey);
